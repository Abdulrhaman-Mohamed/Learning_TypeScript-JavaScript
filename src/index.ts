/* console.log('Abdo');
let array:any=[1,2,3,'a','s',[55,5,"a"]];
...
/* function printInConsole(...nums:(number[]| string[] | boolean[])):void
{
    nums.forEach((num) => num == undefined? "Done"  :console.log(`The value is ${num} and tpye is ${typeof(num)}` ));
}
